package com.del.webapp.entity;
public class Courses 
{
	int course_id;
	String course_name;
	double course_duration,course_fee;
	public Courses() {}
	public Courses(int course_id, String course_name, double course_duration, double course_fee) 
	{
